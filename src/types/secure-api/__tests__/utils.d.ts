 ...
 */
export declare function createFetchMock(mockResponses: Record<string, (url: string, options?: RequestInit) => Promise<Response>>): (input: RequestInfo | URL, options?: RequestInit) => Promise<Response>;
/**
 ...
 */
export declare function mockJsonResponse(data: any, options?: {
    status?: number;
 ...
 * mockFetch.restore();
 */
export declare function setupFetchMock(mockResponses: Record<string, (url: string, options?: RequestInit) => Promise<Response>>): {
    restore: () => void;
};
