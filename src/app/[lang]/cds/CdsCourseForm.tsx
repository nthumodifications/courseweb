...
import { Plus, Trash, AlertTriangle, Save, Copy, Settings, Send, LogOut, Info } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 rounded-sm mt-3">
                ...
                <div className="flex flex-col gap-4 px-4">
                    ...
                    <div className='flex flex-row'>
                        <Button variant="outline" onClick={e => setOpen(true)} className='flex-1'><Plus /> Add Course</Button>
                        <DropdownMenu>
                            <DropdownMenuTrigger>
                                <Button
                                    size="icon"
                            ...
                            <DropdownMenuContent>
                                <DropdownMenuLabel>
                                    時間表
                                    <Switch checked={showTimetable} onCheckedChange={(v) => setShowTimetable(v)} />
                                </DropdownMenuLabel>
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </div>
                    ...
                    {semesterSelectedCourses.map((course, index) => (
                        <div key={index} className="flex flex-row gap-4 items-center">
                            ...
                            <div className="flex flex-row space-x-2 items-center">
                                {timeConflicts.find(ts => ts.course.raw_id == course.raw_id) && <HoverCard>
                                ...
                                {duplicates.includes(course.raw_id) && <HoverCard>
                                    <HoverCardTrigger asChild>
                                ...
                                <div className='flex flex-row'>
                                    <Button className='rounded-l-none' variant="outline" size="icon" onClick={() => deleteCourse(course)}>
                                        <Trash className="w-4 h-4" />
                                    </Button>
                                </div>
                            </div>
