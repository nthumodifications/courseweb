...
import {
  useConnector,
  useRefinementList as _useRefinementList,
} from "react-instantsearch-core";

const useCustomRefinementList: typeof _useRefinementList = (
  props,
  additionalWidgetProperties,
) => {
  const overridenConnectRefinementList: typeof connectRefinementList = (
    renderFn,
    unmountFn,
  ) => {
  ...
  return useConnector(
    overridenConnectRefinementList,
    props,
    additionalWidgetProperties,
  );
};
