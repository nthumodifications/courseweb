import { useStats, useInfiniteHits, useInstantSearch } from 'react-instantsearch';
  ...
  return <div className="flex w-full gap-4">
    ...
    <div className="flex flex-col gap-4 flex-1">
      <div className="flex items-end ml-4">
        ...
        <a href="https://www.algolia.com/?utm_medium=AOS-referral" target="_blank" rel="noopener noreferrer">
