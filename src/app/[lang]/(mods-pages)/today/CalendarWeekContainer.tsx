...
export const CalendarWeekContainer = ({ displayWeek }: { displayWeek: Date[]; }) => {
    ...
    return (
        ...
        <div className="overflow-x-auto">
            <div className="flex flex-col min-w-[580px] md:min-w-0">
                ...
                <div className="h-[70vh] w-full flex flex-row overflow-y-auto scrollbar-none" ref={displayContainer}>
