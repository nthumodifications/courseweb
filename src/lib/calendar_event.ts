...
export const getNTHUCalendar = async () => {
    ...
    const CALENDAR_API_URL = `https://www.googleapis.com/calendar/v3/calendars/nthu.acad%40gmail.com/events?key=${CLOUD_API}&timeMin=${new Date().toISOString().slice(0, 10)}T00:00:00Z&timeMax=${new Date(Date.now() + 86400000 * 7).toISOString().slice(0, 10)}T00:00:00Z`
