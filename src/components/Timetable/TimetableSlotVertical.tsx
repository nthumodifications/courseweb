...
const TimetableSlotVertical: FC<TimetableSlotProps> = ({
  course,
  tableDim,
  fraction = 1,
  fractionIndex = 1,
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex flex-col justify-start h-full p-1 select-none",
          flexAlign,
        )}
      ...
      >
        ...
        >
          ...
          {preferences.display.title &&
            (displayLang == "zh" ? (
              <span className={cn("text-xs md:text-sm font-medium", textAlign)}>
          ...
          {preferences.display.time && (
            <span className="text-xs" id="time_slot">
