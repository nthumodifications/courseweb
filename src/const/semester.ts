...
export const semesterInfo = [
    // { id: '11010', year: 2022, semester: 1, begins: new Date(2021, 9-1, 13), ends: new Date(2022, 1-1, 14) },
    // { id: '11020', year: 2022, semester: 2, begins: new Date(2022, 2-1, 14), ends: new Date(2022, 6-1, 17) },
    ...
    { id: '11220', year: 2023, semester: 2, begins: new Date(2024, 2-1, 19), ends: new Date(2024, 6-1, 21) }
]
