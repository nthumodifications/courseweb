...
export const GETargetCodes = [
    {
        ...
        description_en: 'For all students all credits are accepted as General Education.'
    },
    // {
    //     code: '*2',
    //     short_zh: '限人文社會學院學生',
    ...
    // },
    {
        ...
        description_zh: '全校學生皆可選修；但開課系(所)所屬(院)學生選修，不列入通識課程學分',
        description_en: 'For all students the credits are accepted as General Education but not for the students registered in the same departments or colleges which offer the courses.'
    },
    // {
    //     code: '*4',
    //     short_zh: '限非開課系所/院學生',
    ...
    },
    {
        ...
        description_zh: '全校學生皆可選修；但開課系(所)之學生選修，不列入通識課程學分',
        description_en: 'For all students the credits are accepted as General Education but not for the students registered in the same department which offer the courses.'
    }
]
